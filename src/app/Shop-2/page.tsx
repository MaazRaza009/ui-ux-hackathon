...
<div className="container mx-auto max-w-5xl bg-white shadow-md rounded-lg p-4">
    ...
    <div className="border-b">
      <nav className="flex space-x-4">
        <a href="#" className="text-blue-600 font-medium border-b-2 border-blue-600 pb-2">Description</a>
        <a href="#" className="text-gray-600 hover:text-blue-600 pb-2">Additional Information</a>
        <a href="#" className="text-gray-600 hover:text-blue-600 pb-2">Reviews (0)</a>
      </nav>
    </div>
